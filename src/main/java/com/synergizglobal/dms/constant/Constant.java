...
public class Constant {
	...
	public static final Map<String, String> METADATA_UPLOAD_VALIDATION_MAP = new HashMap<>() {{
	    put(FILE_NAME, "validateFileName");
	    put(FILE_NUMBER, "validateFileNumber");
	    put(REVISION_NUMBER, "validateRevisionNumber");
	    put(REVISION_DATE, "validateRevisionDate");
	    put(FOLDER, "validateFolder");
	    put(SUB_FOLDER, "validateSubFolder");
	    put(DEPARTMENT, "validateDepartment");
	    put(STATUS, "validateStatus");
	    put(UPLOAD_DOCUMENT, "validateUploadDocument");
	}};
}
