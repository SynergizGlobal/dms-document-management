...
public interface ProjectRepository  extends JpaRepository<Project, String>{
	@Query(value = "select distinct p.project_name from dbo.[project] p\r\n"
	...
	@Query(value = """
			SELECT distinct p.project_name from project as p
  ...
  where scrp.executive_user_id_fk = :userId
			""", nativeQuery = true)
	List<String> getProjectsForOtherUsersByUserId(@Param("userId") String userId);
