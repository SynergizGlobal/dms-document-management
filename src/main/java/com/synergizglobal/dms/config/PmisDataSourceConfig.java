...
@EnableJpaRepositories(
    basePackages = "com.synergizglobal.dms.repository.pmis",
...
public class PmisDataSourceConfig {
    ...
    public DataSource dataSource() {
        ...
        ds.setJdbcUrl("jdbc:sqlserver://115.124.125.227:1433;databaseName=pmis_qa;encrypt=false;");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        return builder
                ...
                .packages("com.synergizglobal.dms.entity.pmis")
